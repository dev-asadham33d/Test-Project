...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create detail' do
    assert_difference('Detail.count') do
      post details_url,
           params: { detail: { email_address: @detail.email_address, first_name: @detail.first_name, last_name: @detail.last_name,
                               nick_name: @detail.nick_name, phone_number: @detail.phone_number } }
    end
